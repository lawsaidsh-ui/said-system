...
CASE_NUMBER = "469/1801/2026"
CLIENT_NAME = "دلال بنت عبدالله بن سعيد الشيبية"
OPPONENT_NAME = "المدينة الطبية الجامعية"
REGISTRATION_DATE = date(2026, 2, 4)
CASE_TYPE = "دعوى ابتدائية"
COURT_NAME = "مجمع المحاكم الخوير، شارع الوزارات، مسقط"
...
def backup_database() -> Path | None:
    ...
    if not database_path.exists():
        return None
    backup_path = ROOT / f"saeed_law.backup-before-manual-case-469-1801-2026-{datetime.now():%Y%m%d-%H%M%S}.db"
...
def ensure_completed_session(db, matter: Matter) -> None:
    ...
    session.decision_summary = "مغلقة حسب حالة الدعوى في بيانات المحكمة."
    session.next_action = "مراجعة ملف القضية وإدخال منطوق الحكم أو سبب الإغلاق عند توفره."
